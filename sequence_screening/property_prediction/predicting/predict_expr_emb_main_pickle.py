...
if __name__ == '__main__':
    ...
    train_feats_mean = np.load(os.path.join(data_root, 'property_prediction/expr/embedding_flatten_mean.npy'))
    train_feats_std = np.load(os.path.join(data_root, 'property_prediction/expr/embedding_flatten_mean.npy'))
    ...
    if 1:
        ...
        np.save(os.path.join(data_root, 'predicts/expr/{}/predict_cls_all.npy'.format(rbd_name)), y_cls)
        np.save(os.path.join(data_root, 'predicts/expr/{}/predict_reg_all.npy'.format(rbd_name)), y_reg)
